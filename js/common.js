...
function setWeb3Events(_provider) {
  //This event triggers when the user switches accounts in their wallet (e.g., in MetaMask).
  ...
  //This event triggers when the user switches the blockchain network
